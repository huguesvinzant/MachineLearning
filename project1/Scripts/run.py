...
best_degree0, best_lambda0, best_score0, _ = find_best_parameters_general(labels0, std_data0, k_fold, seed, lambdas=lambdas, degrees=degrees)
print('Ridge regression... : 0 jet:', 'Best degree:', best_degree0, 'Best lambda:', best_lambda0, 'Best score:', best_score0)

best_degree1, best_lambda1,  best_score1, _ = find_best_parameters_general(labels1, std_data1, k_fold, seed, lambdas=lambdas, degrees=degrees)
print('Ridge regression... : 1 jet:', 'Best degree:', best_degree1, 'Best lambda:', best_lambda1, 'Best score:', best_score1)

best_degree2, best_lambda2, best_score2, _ = find_best_parameters_general(labels2, std_data2, k_fold, seed, lambdas=lambdas, degrees=degrees)
print('Ridge regression... : 2 or more jets:', 'Best degree:', best_degree2, 'Best lambda:', best_lambda2, 'Best score:', best_score2)

#Prediction

y_pred0 = make_predictions(std_data0, labels0, std_data0_te, best_lambda0, best_degree0)
y_pred1 = make_predictions(std_data1, labels1, std_data1_te, best_lambda1, best_degree1)
y_pred2 = make_predictions(std_data2, labels2, std_data2_te, best_lambda2, best_degree2)
...
best_degree0, best_lambda0, best_score0, _ = find_best_parameters_general(labels0, std_data0, k_fold, seed, lambdas=lambdas, degrees=degrees, gamma=gamma)
print('Logistic regression...: 0 jet:', 'Best degree:', best_degree0, 'Best lambda:', best_lambda0, 'Best score:', best_score0)

best_degree1, best_lambda1, best_score1, _ = find_best_parameters_general(labels1, std_data1, k_fold, seed, lambdas=lambdas, gamma=gamma, degrees=degrees)
print('Logistic regression...: 1 jet:', 'Best degree:', best_degree1, 'Best lambda:', best_lambda1, 'Best score:', best_score1)

best_degree2, best_lambda2, best_score2, _ = find_best_parameters_general(labels2, std_data2, k_fold, seed, lambdas=lambdas, gamma=gamma, degrees=degrees)
print('Logistic regression...: 2 or more jets:', 'Best degree:', best_degree2, 'Best lambda:', best_lambda2, 'Best score:', best_score2)

#Prediction 

max_iters = 1000
y_pred0 = make_predictions_log(std_data0, labels0, std_data0_te, best_lambda0, best_degree0, max_iters, gamma)
y_pred1 = make_predictions_log(std_data1, labels1, std_data1_te, best_lambda1, best_degree1, max_iters, gamma)
y_pred2 = make_predictions_log(std_data2, labels2, std_data2_te, best_lambda2, best_degree2, max_iters, gamma)
